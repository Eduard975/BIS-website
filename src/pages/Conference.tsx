...
function Conference() {
  return (
    <>
      ...
      >
        {/* Updated Title and Subtitle to match the image */}
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-12 lg:gap-20">
          ...
          <SectionContent className="w-full md:w-[60%] text-justify">
            <div className="flex flex-col gap-6 text-darkTxt text-lg leading-relaxed">
              <p>
                ...
                <strong>STEM industry leaders</strong> from across Europe to
                shape the future of{" "}
              ...
              <p>
                ...
                <strong>global tech companies</strong>, or be inspired by
                diverse keynote speakers, this is the place to be.
              </p>
          ...
          {/* Right Side: Image aligned to top and matching text height */}
          <div className="w-full md:w-[40%] self-stretch flex overflow-hidden rounded-2xl md:rounded-3xl shadow-sm">
            <img
              ...
              className="
                  ...
                  object-cover 
                  object-center 
                  /* Now that the parent has overflow-hidden, scale will zoom INSIDE the box */
                  scale-[1.4]
                "
            />
          </div>
